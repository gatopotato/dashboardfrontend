    ...
    const handleLogin = async () => {
        try {
            ...
            if (response.data) {
                ...
                console.log('Login successful, navigating to head home');
                navigate('/head/home', { state: { data: response.data } });
            }
        } catch (error) {
        ...
        <>
            <div className="flex flex-row min-h-screen justify-center items-center">
                <Card className="w-[350px]">
                    <CardHeader>
                        <CardTitle>Head Login</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <form
                            onSubmit={(e) => {
